...
DESC
s.homepage     = "https://github.com/Quinn0809/QUIAdaptiveKit.git"
s.license          = { :type => 'MIT', :file => 'LICENSE' }

s.author             = { "quinn0809" => "quinn_f@126.com" }
s.source       = { :git => "https://github.com/Quinn0809/QUIAdaptiveKit.git.git", :tag => s.version.to_s }

s.ios.deployment_target = '10.0'
s.swift_version         = '4.0'
s.requires_arc          = true
s.static_framework      = true
s.source_files          = ['QUIAdaptiveKit/Classes/**/*.{swift,h}']
